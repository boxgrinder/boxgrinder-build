  ...
  class ApplianceVMXImage < Rake::TaskLib
    ...
    def define_precursors
      ...
      file @base_vmware_raw_file => [ @vmware_directory, @appliance_xml_file, "rpm:vm2-support:sign" ] do
        ...
        @appliance_image_customizer.customize( @base_vmware_raw_file,  { :local => [ "noarch/vm2-support-1.0.0.Beta1-1.noarch.rpm" ], :remote => [ "open-vm-tools" ] }, [ "http://download1.rpmfusion.org/free/fedora/rpmfusion-free-release-stable.noarch.rpm", "http://download1.rpmfusion.org/nonfree/fedora/rpmfusion-nonfree-release-stable.noarch.rpm" ])
      end
