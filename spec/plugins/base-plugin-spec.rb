...
module BoxGrinder
  describe BasePlugin do
    ...
    it "should register a metadata deliverable" do
      ...
      @plugin.deliverables.a_name.should == "build/appliances/#{@arch}/fedora/11/full/plugin_name/a_path"
    end
    ...
    it "should register multiple other deliverables" do
      ...
      @plugin.deliverables.a_name.should == "build/appliances/#{@arch}/fedora/11/full/plugin_name/a_path"
      @plugin.deliverables.a_second_name.should == "build/appliances/#{@arch}/fedora/11/full/plugin_name/a_path_too"
    end
