...
class ApplianceValidatorTest < Test::Unit::TestCase
  ...
  def test_init_and_raise_validation_error_if_file_is_nil
    assert_raise JBossCloud::ApplianceValidationError do
      JBossCloud::ApplianceValidator.new( "../test/src/appliances", nil )
    end
  end
  
  def test_init_and_raise_validation_error_if_file_doesnt_exists
    assert_raise JBossCloud::ApplianceValidationError do
      JBossCloud::ApplianceValidator.new( "../test/src/appliances", "strange/path.appl" )
    end
  end
  
  def test_appliance_without_summary
    validator = JBossCloud::ApplianceValidator.new( "../test/src/appliances", "../test/src/appliances/without-summary-appliance/without-summary-appliance.appl" )
    assert_raise JBossCloud::ApplianceValidationError do
      validator.validate
    end
  end
  ...
  def test_multiappliance_without_dependent_appliance
    validator = JBossCloud::ApplianceValidator.new( "../test/src/appliances", "../test/src/appliances/without-dependent-appliances-appliance/without-dependent-appliances-appliance.appl" )
  ...
  def test_valid_data
    validator = JBossCloud::ApplianceValidator.new( "../test/src/appliances", "../test/src/appliances/valid-appliance/valid-appliance.appl" )
    assert_not_nil validator , "Validator shouldn't be nil!"
    validator.validate
  end
end
