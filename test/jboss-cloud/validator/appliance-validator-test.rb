  ...
  class ApplianceValidatorTest < Test::Unit::TestCase
    ...
    def test_nil_appliances_dir
      assert_raise JBossCloud::ApplianceValidationError do
        JBossCloud::ApplianceValidator.new( nil, nil, @options )
      end
    end

    def test_doesnt_exists_appliances_dir
      assert_raise JBossCloud::ApplianceValidationError do
        JBossCloud::ApplianceValidator.new( "bled/sd/sd", nil, @options )
      end
    end

    def test_init_and_raise_validation_error_if_file_is_nil
      assert_raise JBossCloud::ApplianceValidationError do
        JBossCloud::ApplianceValidator.new( "../test/src/appliances", nil, @options )
      end
    end

    def test_init_and_raise_validation_error_if_file_doesnt_exists
      assert_raise JBossCloud::ApplianceValidationError do
        JBossCloud::ApplianceValidator.new( "../test/src/appliances", "strange/path.appl", @options )
      end
    end

    def test_appliance_without_summary
      validator = JBossCloud::ApplianceValidator.new( "../test/src/appliances", "../test/src/appliances/without-summary-appliance/without-summary-appliance.appl", @options )
      assert_raise JBossCloud::ApplianceValidationError do
        validator.validate
      end
    end
    ...
    def test_multiappliance_without_dependent_appliance
      validator = JBossCloud::ApplianceValidator.new( "../test/src/appliances", "../test/src/appliances/without-dependent-appliances-appliance/without-dependent-appliances-appliance.appl", @options )
    ...
    def test_valid_data
      validator = JBossCloud::ApplianceValidator.new( "../test/src/appliances", "../test/src/appliances/valid-appliance/valid-appliance.appl", @options )
      assert_not_nil validator, "Validator shouldn't be nil!"
      validator.validate
    end
  end
